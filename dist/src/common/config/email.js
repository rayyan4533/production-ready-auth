...
export const sendVerificationEmail = async (email, token) => {
    ...
    await sendEmail(email, "Verify your email", `<h2>Welcome!</h2><p>Click <a href="${url}">here</a> to verify your email.</p>`);
};
...
export const sendResetPasswordEmail = async (email, token) => {
    ...
    await sendEmail(email, "Reset your password", `<h2>Password Reset</h2><p>Click <a href="${url}">here</a> to reset your password. This link expires in 15 minutes.</p>`);
};
